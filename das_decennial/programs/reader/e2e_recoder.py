...
class DHCP_HHGQ_recoder:
    ...
    """
    def __init__(self, race_list, rel_varname_list):
...
class table9a_recoder:
    """
        ...
        It creates cenrace.
    """
    def __init__(self, race_list, age):
        self.race = race_list
        self.age = age[0]
    def recode(self, row):
        """
...
def votingage_recode2(row, age_var):
...
def hhgq_detail_recode(row, rel_var):
    """
    """
