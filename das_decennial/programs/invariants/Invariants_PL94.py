...
class InvariantsCreator(querybase_invariants.AbstractInvariantsCreator):
    ...
    schema:  {'hhgq': 0, 'voting': 1, 'hispanic': 2, 'cenrace': 3}
    Person histogram shape is: (8, 2, 2, 63)
    ...
    def tot(self):
        ...
        self.addToInvariantsDict(self.raw, (0, 1, 2, 3), "tot", groupings=None)

    def va(self):
        """ Summing over all axes except 'voting' (1) and subsetting axis 1 to value 1 (voting age)"""
        self.addToInvariantsDict(self.raw, (0, 2, 3), "va", groupings={1: [[1]]})
