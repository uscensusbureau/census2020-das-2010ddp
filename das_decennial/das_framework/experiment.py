...
def draw_graph(*,config,datax,datay):
    ...
    ax.plot(datax,datay)
    ax.set_xlabel( config[driver.EXPERIMENT].get(driver.EXPERIMENT_XLABEL,'') )
    ax.set_ylabel( config[driver.EXPERIMENT].get(driver.EXPERIMENT_YLABEL,'') )
    ax.set_title(  config[driver.EXPERIMENT].get(driver.EXPERIMENT_TITLE,'') )
    ...
    if str_to_bool( config[driver.EXPERIMENT].get(driver.EXPERIMENT_DRAW_LEGEND, '')):
        ax.legend([txt],loc='best')
    fig.savefig( os.path.join(config[driver.EXPERIMENT][driver.EXPERIMENT_DIR],
